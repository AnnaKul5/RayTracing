...
struct SCamera
{
    ...
    vec3 Up;
    vec3 Side;
    vec2 Scale;      // Aspect ratio of the output image
};
...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[10])
{
    ...
    /** MATERIALS **/
    // Left wall material 
    materials[0].Color = vec3(0.0, 0.52, 0.7);
    materials[0].LightCoeffs = vec4(lightCoefs);
    materials[0].ReflectionCoef = 0.11;
    materials[0].RefractionCoef = 1;
    materials[0].MaterialType = REFLECTION;

    // Front wall material 
    materials[1].Color = vec3(0.14, 0.16, 0.39);
    ...
    // Right wall material 
    materials[2].Color = vec3(0.11, 0.56, 0.59);
    materials[2].LightCoeffs = vec4(lightCoefs);
    materials[2].ReflectionCoef = 0.11;
    materials[2].RefractionCoef = 1;
    materials[2].MaterialType = REFLECTION;

    // Back wall material 
    materials[3].Color = vec3(0.1, 0.28, 0.6);
    ...
    // Ceiling material 
    materials[4].Color = vec3(0.38, 0.75, 0.97);
    ...
    // Floor material 
    materials[5].Color = vec3 (0.55, 0.65, 0.93);
